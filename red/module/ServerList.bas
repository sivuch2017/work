...
'シート名
Public Const strSheetName As String = "サーバー"

'対象テーブル
Private Const TABLES As String = ""

'更新可能カラム名
Private Const typeUpd As String = ""

'カラム⇒テーブル
Private Const ColToTable As String = ""

'更新可能カラム名(テーブル側)
Private Const tableUpd As String = ""
...
Public Sub CreateSheet()
    ...
    loadTable sht, "SELECT * FROM ServerList ORDER BY sort_ip", maxCol, "Courier New"
...
Public Sub CheckSheet()
    ...
    CheckList shtList, "SELECT * FROM ServerList"
